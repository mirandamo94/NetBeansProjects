...
@NamedQueries({
    ...
    , @NamedQuery(name = "OrderedProduct.findByUserOrderId", query = "SELECT o FROM OrderedProduct o WHERE o.orderedProductPK.userOrderId = :userOrderId")
...
public class OrderedProduct implements Serializable {
    ...
    public OrderedProduct(int userOrderId, int productId) {
        this.orderedProductPK = new OrderedProductPK(userOrderId, productId);
    }
